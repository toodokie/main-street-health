        ...
        <div class="pxl-carousel-inner ">
            <div <?php pxl_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
                <div class="pxl-swiper-wrapper">
                    ...
                    $is_injury = (isset($settings['post_type']) && $settings['post_type'] === 'injury');
                    foreach ($posts as $post):
                        ...
                        $injury_icon_id = $is_injury ? (int) get_post_meta($post->ID, '_injury_icon_id', true) : 0;
                            ...
                            <div class="pxl-post--inner <?php echo esc_attr($pxl_animate); ?> wow" data-wow-duration="1.2s">
                                <div class="pxl-post--featured">
                                    <a href="<?php echo esc_url(get_permalink( $post->ID )); ?>">   
                                        ...
                                        <?php elseif($is_injury && $injury_icon_id) : ?>
                                            <span class="pxl-post--icon">
                                                <?php echo wp_get_attachment_image($injury_icon_id, 'full'); ?>
                                            </span>
                                        <?php endif; ?>
                                    </a>
                                </div>
