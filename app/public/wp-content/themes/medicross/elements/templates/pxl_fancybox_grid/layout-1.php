...
$layout_mode = isset($settings['layout_mode']) ? $settings['layout_mode'] : 'masonry';
?>
<?php if(isset($settings['box']) && !empty($settings['box']) && count($settings['box'])): ?>
    <div class="pxl-grid pxl-box-grid pxl-box-grid1 " data-layout="<?php echo esc_attr($layout_mode); ?>">
