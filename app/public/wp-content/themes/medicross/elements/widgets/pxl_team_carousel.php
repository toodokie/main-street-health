...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Case Team Carousel', 'medicross'),
        ...
        'params' => array(
            'sections' => array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'controls' => array(
                                ...
                                array(
                                    'name' => 'social',
                                    'label' => esc_html__( 'Social', 'medicross' ),
                                    'type' => 'pxl_icons',
                                ),
                                array(
                                    'name' => 'item_link',
                    ...
                    'controls' => array(
                        array(
                            ...
                            'controls' => array(
                                ...
                                array(
                                    'name' => 'level',
                                    'label' => esc_html__('Educaition Level', 'medicross'),
                                    'type' => \Elementor\Controls_Manager::TEXTAREA,
                                ),
                                array(
                                    'name' => 'item_link2',
                ...
                array(
                    ...
                    'label' => esc_html__('Carousel Settings', 'medicross'),
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'color_dot',
                            'label' => esc_html__('Color Dot', 'medicross' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'color_dotat',
                            'label' => esc_html__('Color Dot Active', 'medicross' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
