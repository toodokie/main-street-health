...
$wizard = new Merlin(
	...
	$strings = array(
		...
		/* translators: Theme Name */
		'welcome-header%s'         => esc_html__( 'Let\'s Get You Started', 'medicross' ),
		'welcome-header-success%s' => esc_html__( 'Hi. Welcome back', 'medicross' ),
		'welcome%s'                => esc_html__( 'Thanks for purchasing theme! You can now register your product to install plugins, import demos and unlock exlusive features.', 'medicross' ),
		...
		'ready-header'             => esc_html__( 'You\'re Ready!', 'medicross' ),
		...
		'ready-link-2'             => sprintf( '<a href="%1$s" target="_blank">%2$s</a>', $pxl_server_info['email_support'], esc_html__( 'Get Theme Support', 'medicross' ) ),
