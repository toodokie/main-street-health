	...
	<div class="pxl-dashboard-wrap">
						...
						<div class="pxl-col pxl-col-12">
							<div class="pxl-imp-skip-posts">
								<span class="pxl-imp-opt-skip-posts" style="margin-bottom: 0; padding-left: 15px;">
									...
									<span><?php esc_html_e( 'Skip the posts existen, ( Default clear all content ).', 'medicross' ); ?></span>
									</label>
								</span>
							</div>
							<div class="pxl-imp-crop">
								<span class="pxl-imp-opt-crop" style="margin-bottom: 0; padding-left: 15px;">
									...
									<label for="pxl-imp-crop-img"><span><?php esc_html_e( 'Crop Image after import finish?', 'medicross' ); ?></span></label>
								</span>
							</div>
		...
		<div class="pxl-progress-popup pxl-imp-popup-wrap">
			<div class="pxl-imp-progress">
				...
				<div class="pxl-progress importing"><?php esc_html_e( 'Working', 'medicross' )?> <span>.</span><span>.</span><span>.</span></div>
				<div class="pxl-progressbar">
					<div class="pxl-progressbar-inner" style="width: 0%">
						<span class="pxl-loader pxl-progressbar-percentage"><?php esc_html_e( '0%', 'medicross' ); ?></span>
					</div>
				</div>
			</div>
		</div>  
