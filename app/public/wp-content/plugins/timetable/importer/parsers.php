...
class WXR_Parser_XML {
	...
	function parse( $file ) {
		...
		if ( ! xml_parse( $xml, file_get_contents( $file ), true ) ) {
			...
			return new WP_Error( 'XML_parse_error', esc_html__('There was an error when reading this WXR file', 'wordpress-importer'), array( $current_line, $current_column, $error_string ) );
		}
		xml_parser_free( $xml );
